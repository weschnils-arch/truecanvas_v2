    ...
    <div ref={containerRef} className="bg-[#F7F6F4] min-h-screen font-sans">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-16">
          <p className="text-[11px] tracking-archive uppercase text-charcoal/60 mb-2">
            Weyringergasse 19/1-3, 1040 Wien
          </p>
          <p className="text-[11px] tracking-journal uppercase text-charcoal/60 mb-10">
            Wien seit 2018
          </p>
          <a
